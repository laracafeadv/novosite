---
titulo: Como funciona um divórcio consensual
categoria: Divórcio e Separação
resumo: Divórcio consensual não significa que não há dor, só que não há
  disputa. Entenda como funciona o processo, do primeiro acordo à
  homologação final.
...
O [divórcio consensual](/glossario/divorcio-consensual.html) significa que o casal já chegou a um acordo sobre os pontos principais da separação, entre eles a partilha de bens, o uso do nome e, quando houver filhos, as regras de convivência e sustento. O consenso não precisa existir desde o primeiro dia, muitas vezes ele é construído justamente durante as conversas que antecedem o divórcio.

## O nome depois do divórcio

Um dos pontos que o divórcio também resolve é o nome. Quem adotou o sobrenome do outro no casamento pode optar por voltar a usar o nome de solteiro, ou manter o nome de casado, essa escolha é de quem toma a decisão, não depende da concordância do ex-cônjuge.
...
A partilha alcança também as dívidas contraídas durante o casamento, não só os bens. O financiamento de um carro assumido pelos dois, por exemplo, segue a mesma lógica de divisão, mesmo que o contrato esteja no nome de apenas um dos cônjuges.
