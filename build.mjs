  ...
  if (caminho === '') {
    const comoFunciona = {
      ...
      step: [
        ...
        { '@type': 'HowToStep', position: 5, name: 'Solução', text: 'Uma solução jurídica sólida em Direito de Família e Sucessões, construída para durar e não apenas para resolver o momento.' },
      ],
    };
